defmodule GuessTheSong.Helpers.Levenshtein do
  @moduledoc """
  ...
  @spec levenshtein_ratio(String.t(), String.t()) :: float()
  @doc "Calculates the Levenshtein ratio between two strings."
  def levenshtein_ratio(a, b) do
