defmodule GuessTheSong.Quiz.Supervisor do
  ...
  """
  def start_session(interaction, guild_id, text_channel_id, voice_channel_id, rounds) do
    case active?(guild_id) or GuessTheSong.Voice.Supervisor.active?(guild_id) do
